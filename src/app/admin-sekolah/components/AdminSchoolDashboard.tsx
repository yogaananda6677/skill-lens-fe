      ...
      <div className="rounded-2xl bg-gradient-to-b from-blue-50/90 to-white p-6">
        ...
        <div className="-mx-6 -mt-6 mb-6 rounded-t-2xl bg-gradient-to-r from-[#0a1a3a] to-[#0f2a5f] px-6 py-5">
          <div className="flex items-center gap-2">
            ...
            <p className="text-xs font-semibold uppercase tracking-wide text-blue-100">Dashboard</p>
          </div>
          <h2 className="mt-2 text-xl font-bold text-white">Ringkasan Admin Sekolah</h2>
          <p className="mt-1 text-sm text-blue-100">
            Pantau status sekolah, akses menu, dan lihat ringkasan data.
          </p>
        </div>

        {/* Status sekolah (gaya seperti sebelumnya tapi lebih rapi) */}
        <div className="mb-6 rounded-xl border border-blue-100 bg-blue-50/80 px-5 py-3 text-sm text-slate-700 shadow-sm">
        ...
        <div className="mt-8 grid gap-5 md:grid-cols-3">
          {[
            ...
            <div
              key={item.label}
              className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-white via-blue-50/50 to-blue-100/20 p-4 shadow-md border border-blue-100/60"
            >
              ...
              <div className="absolute bottom-0 left-0 h-0.5 w-full bg-gradient-to-r from-blue-400 to-cyan-400 opacity-70" />
            </div>
          ))}
        </div>
      </div>
